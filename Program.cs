...
app.UseStaticFiles(new StaticFileOptions
{
    OnPrepareResponse = context =>
    {
        ...
        // 3. Static Images - 30 days cache with stale-while-revalidate
        if (extension is ".webp" or ".avif" or ".png" or ".jpg" or ".jpeg" or ".svg" or ".ico" or ".jfif" or ".gif")
        {
            headers.CacheControl = "public,max-age=2592000,stale-while-revalidate=86400";
            return;
        }

        // 4. Stylesheets & Scripts (non-versioned fallback) - 1 day with stale-while-revalidate
        ...
        // 5. General static files (webmanifest, text files, etc.)
